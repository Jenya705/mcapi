...
public enum DefaultPermission {
    ...
    EVENT_TUNNEL_MENU_CLICK(Permissions.EVENT_TUNNEL_MENU_CLICK, true, false, true),
    EVENT_TUNNEL_ENTITY_SPAWN_LISTEN(Permissions.EVENT_TUNNEL_ENTITY_SPAWN_LISTEN, true, false, true),
    EVENT_TUNNEL_ENTITY_SPAWN_CAPTURED_ENTITY(Permissions.EVENT_TUNNEL_ENTITY_SPAWN_CAPTURED_ENTITY, true, false, true),
    EVENT_TUNNEL_ENTITY_SPAWN_ENTITY(Permissions.EVENT_TUNNEL_ENTITY_SPAWN_ENTITY, true, false, false),
    EVENT_TUNNEL_ENTITY_DESPAWN_LISTEN(Permissions.EVENT_TUNNEL_ENTITY_DESPAWN_LISTEN, true, false, true),
    EVENT_TUNNEL_ENTITY_DESPAWN_CAPTURED_ENTITY(Permissions.EVENT_TUNNEL_ENTITY_DESPAWN_CAPTURED_ENTITY, true, false, true),
    EVENT_TUNNEL_ENTITY_DESPAWN_ENTITY(Permissions.EVENT_TUNNEL_ENTITY_DESPAWN_ENTITY, true, false, false),
    EVENT_TUNNEL_INVENTORY_MOVE_LISTEN(Permissions.EVENT_TUNNEL_INVENTORY_MOVE_LISTEN, false, false, false),
    EVENT_TUNNEL_INVENTORY_MOVE_UUID_HOLDER(Permissions.EVENT_TUNNEL_INVENTORY_MOVE_UUID_HOLDER, false, false, false),
    EVENT_TUNNEL_INVENTORY_MOVE_BLOCK(Permissions.EVENT_TUNNEL_INVENTORY_MOVE_BLOCK, false, false, false),
    ...
    PLAYER_CLOSE_INVENTORY(Permissions.PLAYER_CLOSE_INVENTORY, false, true, false)
    ;
