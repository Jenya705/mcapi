...
public class RouteWebRequestPreProcessor implements WebRequestPreProcessor {
    ...
    @Override
    public void fillParameters(WebRequest request, Map<String, String> parameters) {
        pathTemplate.match(request.getRoute().getPath(), parameters);
    }
    ...
    static final class UriPathTemplate {
        ...
        public void match(String uri, Map<String, String> parameters) {
